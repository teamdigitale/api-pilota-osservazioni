...
python-flask-generate: openapi/osservazioni.yaml
	...
	java -jar scripts/swagger-codegen-cli.jar generate -l python-flask -i  openapi/osservazioni.yaml -o python-flask
